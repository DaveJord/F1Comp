...
7. Players selections for each race should be in the format "1st, 2nd, 3rd, 4th, 5th" e.g. "STR, PIA, VER, HAM, RUS", other variations, including either a drivers full name, first name, surname are acceptable, provided it uniquely identifies that driver and it is clear what classification the player intended.
